...
Executable to delete files which fitting certain criteria. 
...
== Options
  ...
  -t, --threshold   Treshold date for when to start deleting files.
                    ...
                    -t=10.days.ago or -t= 2.months.ago
                
  -h, --hourly      Keep hourly hourly
  -d, --daily       Keep daily backups
  -w, --weekly      Keep weekly backups
  -m, --monthly     Keep monthly backups
  -y, --yearly      Keep yearly backups 
